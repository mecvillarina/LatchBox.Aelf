    ...
    if (aelf) {
        let result = await aelf.login({
            ...
            payload: {
                ...
                //contracts: [{
                //    chainId: "AELF",
                //    contractAddress: "2gaQh4uxg6tzyH1ADLoDxvHA14FMpzEiMqsQ6sDG5iHT8cmjp8",
                //    contractName: 'Genesis',
                //    description: 'contract Genesis',
                //    github: ''
                //}, {
                //    chainId: "AELF",
                //    contractAddress: "25CecrU94dmMdbhC3LWMKxtoaL4Wv8PChGvVJM6PxkHAyvXEhB",
                //    contractName: 'Token',
        ...
        localStorage.setItem("wallet", result.detail);
        const wallet1 = {
            address: walletAddress
        };
...
export async function Logout() {
    walletAddress = null;
    localStorage.setItem("localStorage.removeItem", result.detail);
    if (aelf) {
