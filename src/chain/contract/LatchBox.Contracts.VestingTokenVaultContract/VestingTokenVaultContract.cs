...
{
    /// <summary>
    /// The C# implementation of the contract defined in vesting_token_vault_contract.proto that is located in the "protobuf"
    /// folder.
    /// Notice that it inherits from the protobuf generated code. 
    /// </summary>
    public class VestingTokenVaultContract : VestingTokenVaultContractContainer.VestingTokenVaultContractBase
    {
        /// <summary>
